...
### A0-1 清掉 SP-2.6 / SP-3.3 / SP-5.3 廢除後的全部殘留 ✅ **已完成**
...
### A0-2 裁決 SP-7.3 第 4 點的殘差門檻要改成什麼 ✅ **已完成**（改以同一格自己的非零軸為基準）
...
### A0-3 裁決 SP-8.9 的嘴型反推公式（不做會讓 SpriteController 接反）✅ **已完成**
...
### A0-4 更正「eslint 會擋 tools/*.mjs」這個未實測的斷言 ✅ **已完成**
...
### A0-5 把 CSP 結論寫進版控 ✅ **已完成（2026-09-21）** → 規格 §10 已有答案表
...
### A0-6 清掉「已經做完卻仍被文件宣告為待辦」的四處 ✅ **已完成（2026-09-21）**
...
### A0-7 收斂 `P2-handoff.md` 的全部過期處（範圍比原計畫大）✅ **已完成（2026-09-21）**
...
### A4-1 改寫 `src/README.md`（唯一會隨 dist/ 出貨的文件）✅ **已完成（2026-09-21）**
